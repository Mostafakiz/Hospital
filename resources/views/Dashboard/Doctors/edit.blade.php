                ...
                <form action="{{ route('Brands.update', 'test') }}" method="post" autocomplete="off"
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                ...
                                <label class="form-check-label" for="flexCheckIndeterminate">
                                    {{ $brand->is_active == 1 ? trans('MainCategories_trans.Enabled') :
                                    trans('MainCategories_trans.Notenabled') }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <img src="{{ URL::asset('images/brands/'.$brand->photo) }}" name="photo"
                        ...
                        <button type="submit" class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">{{
                            trans('MainCategories_trans.submit') }}</button>
                    </div>
                </form>
            </div>
        </div>
