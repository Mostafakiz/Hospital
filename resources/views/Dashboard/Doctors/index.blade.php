...
@section('title')
{{trans('Dashboard/main-sidebar-transe.doctors')}}
@stop
@section('css')
...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/main-sidebar-transe.doctors')}}</h4>
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                {{trans('Dashboard/main-sidebar-transe.view_all')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <a href="{{route('Doctors.create')}}" class="btn btn-primary" role="button"
                        aria-pressed="true">{{trans('Dashboard/Doctors.add_doctor')}}</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{$doctor->status == 1 ?
                                    trans('Dashboard/Doctors.Enabled'):trans('Dashboard/Doctors.Not_enabled')}}
                                </td>

                                <td>{{ $doctor->created_at->diffForHumans() }}</td>
                                <td>
                                    <a class="modal-effect btn btn-sm btn-info"
                                        href="{{route('Doctors.edit',$doctor->id)}}"><i class="las la-pen"></i></a>
